...
<html lang="zxx">
	<head>
		<title id="noPrint">Garage | Manage</title>
		<!-- custom-theme -->
...
<body>		 
   <div class="w3_agileits_top_nav" id="noPrint">
			<ul id="gn-menu" class="gn-menu-main">
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li><a href="manage_customers.php"> <i class="fa fa-users"></i> Customers</a></li>
								<li><a href="manage_vehicles.php"> <i class="fa fa-car"></i> Vehicles</a></li>
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo"><h1><a href="index.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Car Garage </a></h1></li>
