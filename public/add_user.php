...
<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input type="text" name="username" class="form-control1" id="focusedinput" placeholder="Eg Anthony" required>
        </div>
    </div>
...
if (isset($_POST["username"])) {
    ...
    $query = "INSERT INTO users (username,email,password_,DOA,agent)

    VALUES ('{$username}','{$mail}', '{".md5($password)."}', '{$date}','{$agent}')";
