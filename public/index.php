...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="#"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Garage </a></h1></li>
									...
									<li>
										<a href="manage_customers.php">
											...
											<div class="ca-content">
												...
												<h3 class="ca-sub one">Our Customers</h3>
											</div>
										</a>
									</li>
									<li>
										  ...
										  <i class="fa fa-bus" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main one">
												       <?php 
                                                    $query = "SELECT count(*) as total from vehicle_details";
                                                    $result = mysqli_query($con, $query);
                                                    confirm_query($result);
                                                    $data = mysqli_fetch_assoc($result);
                                                    echo $data['total'];
												...
												<h3 class="ca-sub">Our Vehicles</h3>
													...
													<div class="table-responsive">
                                                      ...
                                                      <?php
                                                        ...
                                                        <td><?php echo $count; ?></td>
														  ...
														  <td><span><?php echo $row["trn_date"]; ?></span></td>
