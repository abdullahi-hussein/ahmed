...
<?php
                      ...
                      <tr>
                        ...
                        <td id="noPrint"><a href="edit_user.php?id=<?php echo $row["user_id"]; ?>"class="btn btn-flat btn-pri btn-primary"> <i class="fa fa-pencil"></i> Edit</a> </td>
                        <td id="noPrint"><a href="delete_user.php?id=<?php echo $row["user_id"]; ?>"class="btn btn-flat btn-pri btn-danger"> <i class="fa fa-trash"></i> Delete </a> </td>
                      </tr>
                       <?php $count++;
                    } ?>
                </tr>
